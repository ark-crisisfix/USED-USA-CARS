  ...
  return [
    {
      ...
      subtitle: "A curated space for low-cost, practical EVs that make sense for the Ukraine route.",
      picks: [
        {
          id: "leaf-2018",
          vehicle: "Nissan Leaf SV",
    ...
    },
    {
      ...
      subtitle: "A zone for practical sedans and family SUVs that still look attractive after the full calculation.",
      picks: [
        {
          id: "escape-2020",
          vehicle: "Ford Escape SE",
    ...
    },
    {
      ...
      subtitle: "A natural section for the most impressive and high-ticket lots that fit UAE demand.",
      picks: [
        {
          id: "g63-2021",
          vehicle: "Mercedes-Benz G63 AMG",
    ...
    },
    {
      ...
      subtitle: "A section for unusual, overlooked, or especially attractive opportunities worth surfacing.",
      picks: [
        {
          id: "a6-allroad-2020",
          vehicle: "Audi A6 Allroad",
